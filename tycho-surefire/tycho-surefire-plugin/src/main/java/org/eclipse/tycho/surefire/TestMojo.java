...
public class TestMojo extends AbstractMojo {
     ...
     * </p>
     * 
     * @parameter default-value="${project.build.directory}/work" expression="${installation}"
     */
    private File work;
     ...
     * resulting set of bundles is included in the test runtime. Ignored if
     * {@link #provisionInstallation} is <code>true</code>.
     * </p>
     * 
     * @parameter
     */
     ...
     * specified using this parameter. Ignored if {@link #provisionInstallation} is
     * <code>true</code> .
     * </p>
     * 
     * @parameter
    ...
    /**
     * <p>
     * Whether to use p2 provisioning operations to create the installation under test.
     * <ul>
     * <li>If <code>true</code>, use p2 director to install test bundle, test harness bundles and
     * respective dependencies. This installation mode can be used for integration tests that
     * require a fully p2-provisioned installation. To install a product IU, add it as extra
     ...
     * required.</li>
     * <li>If <code>false</code> (this is the default), all necessary files to define the
     * installation under test like <tt>config.ini</tt> are generated by tycho. This installation
     * mode has the advantage that the installation is minimal (defined by the transitive
     * dependencies of the test bundle plus and the test harness) and existing bundle jars are
     * referenced rather than copied for the installation</li>
     * </ul>
     * 
     ...
     *     &lt;configuration&gt;
     *         &lt;provisionInstallation&gt;true&lt;/provisionInstallation&gt;
     *     &lt;/configuration&gt;
     * &lt;/plugin&gt;
     * &lt;plugin&gt;
     *     &lt;groupId&gt;org.eclipse.tycho&lt;/groupId&gt;
     ...
     * </p>
     * 
     * @parameter default-value="false" expression="${provisionInstallation}"
     * @since 0.19.0
     */
    private boolean provisionInstallation;
     ...
     * 
     * Only relevant if {@link #provisionInstallation} is <code>true</code>. If tests are installed
     * on top of an already existing installation in {@link #work}, this must match the name of the
     * existing profile.
     * 
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        if (provisionInstallation) {
            testRuntime = createProvisionedInstallation();
        } else {
            testRuntime = createEclipseInstallation();
        }
    ...
    private EquinoxInstallation createProvisionedInstallation() throws MojoExecutionException {
        try {
            ...
            manifest.getMainAttributes().putValue("Bundle-SymbolicName", dependencyBundleName); //$NON-NLS-1$
            StringBuilder requireBundle = new StringBuilder();
            requireBundle.append(getTestBundleSymbolicName());
            ...
            manifest.getMainAttributes().putValue("Require-Bundle", requireBundle.toString());
